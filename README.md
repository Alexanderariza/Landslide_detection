...
## Description
This repository is a basic scripts - explained in - for analysing landslides using space-based data in, **Sentinel Playground** and **EO Browser**. Its goal is to facilitate work with big data in the cloud for landslide inventory and rapid mapping in disaster management.

The Custom Processing Script has been created to support the commented practices of [UN-SPIDER Knowledge Portal](http://www.un-spider.org/).
