...
The custom processing script has been created to support the commented practices of **Knowledge Portal** of [UN-SPIDER](http://www.un-spider.org/) program of The United Nations Office for Outer Space Affairs.
